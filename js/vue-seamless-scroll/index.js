!function (t, i) {
  ...
  return function (t) {
      ...
      methods: {
        ...
        touchEnd: function () {
          ...
          if (this.canTouchScroll) {
            var i = void 0,
              e = this.options.direction;
            if (this.delay = 50, 1 === e) this.yPos > 0 && (this.yPos = 0);else if (0 === e) {
              var o = this.realBoxHeight / 2 * -1;
              this.yPos < o && (this.yPos = o);
            } else if (2 === e) this.xPos > 0 && (this.xPos = 0);else if (3 === e) {
    ...
    function e() {
      ...
      for (; h < u; h++) if (null != (i = arguments[h])) for (t in i) n = l[t], s = i[t], r = Array.isArray(s), c && s && ("object" === (void 0 === s ? "undefined" : o(s)) || r) ? (r ? (r = !1, a = n && Array.isArray(n) ? n : []) : a = n && "object" === (void 0 === n ? "undefined" : o(n)) ? n : {}, l[t] = e(c, a, s)) : void 0 !== s && (l[t] = s);
      return l;
    }
