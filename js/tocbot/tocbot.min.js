        ...
        e.exports = function (e) {
          ...
          function i(n, o) {
            var l,
              c,
              a,
              d = o.appendChild((l = n, c = document.createElement("li"), a = document.createElement("a"), e.listItemClass && c.setAttribute("class", e.listItemClass), e.onClick && (a.onclick = e.onClick), e.includeTitleTags && a.setAttribute("title", l.textContent), e.includeHtml && l.childNodes.length ? t.call(l.childNodes, function (e) {
                a.appendChild(e.cloneNode(!0));
              }) : a.textContent = l.textContent, a.setAttribute("href", e.basePath + "#" + l.id), a.setAttribute("class", e.linkClass + r + "node-name--" + l.nodeName + r + e.extraLinkClasses), c.appendChild(a), c));
          ...
          function c(t) {
            var n = 0;
            return t !== document.querySelector(e.contentSelector && null != t) && (n = t.offsetTop, e.hasInnerContainers && (n += c(t.offsetParent))), n;
          }
          function a(t) {
            return -1 !== t.className.indexOf(e.collapsibleClass) && -1 !== t.className.indexOf(e.isCollapsedClass) ? (t.className = t.className.split(r + e.isCollapsedClass).join(""), a(t.parentNode.parentNode)) : t;
          }
          return {
            ...
            updateToc: function (i) {
              ...
              if (l && null !== document.querySelector(e.tocSelector) && u.length > 0) {
                n.call(u, function (t, n) {
                  return c(t) > s + e.headingsOffset + 10 ? (d = u[0 === n ? n : n - 1], !0) : n === u.length - 1 ? (d = u[u.length - 1], !0) : void 0;
                });
                ...
                }), h.nextSibling && -1 !== h.nextSibling.className.indexOf(e.isCollapsedClass) && (h.nextSibling.className = h.nextSibling.className.split(r + e.isCollapsedClass).join("")), a(h.parentNode.parentNode);
              }
            }
          };
        };
          ...
          if ("undefined" != typeof window || u) {
            ...
            return s.destroy = function () {
              ...
              if (u && (i = function () {
                ...
                return e;
              }(r, e || {}), this.options = i, this.state = {}, i.scrollSmooth && (i.duration = i.scrollSmoothDuration, i.offset = i.scrollSmoothOffset, s.scrollSmooth = n(374).initSmoothScrolling(i)), t = c(i), o = a(i), this._buildHtml = t, this._parseContent = o, s.destroy(), null !== (l = o.selectHeadings(i.contentSelector, i.headingSelector)))) {
